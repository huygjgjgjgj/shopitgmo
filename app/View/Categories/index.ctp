<div class="categories index">
	...
	<tr>
		...
		<td><?php echo h($category['Category']['subject']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['detail_short']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['detail']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['image']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['image_large']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['sort']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['status']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['date_added']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['last_modified']); ?>&nbsp;</td>
		<td><?php echo h($category['Category']['lang']); ?>&nbsp;</td>
		<td class="actions">
