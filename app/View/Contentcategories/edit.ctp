...
<?php echo $this->Form->create('Contentcategory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Contentcategory'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Contentcategory.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Contentcategory.id')))); ?></li>
