<div class="members index">
	...
	<tr>
		...
		<td><?php echo h($member['Member']['tel']); ?>&nbsp;</td>
		<td><?php echo h($member['Member']['fax']); ?>&nbsp;</td>
		<td><?php echo h($member['Member']['email']); ?>&nbsp;</td>
		<td><?php echo h($member['Member']['website']); ?>&nbsp;</td>
		<td><?php echo h($member['Member']['uid']); ?>&nbsp;</td>
		<td><?php echo h($member['Member']['pwd']); ?>&nbsp;</td>
		<td><?php echo h($member['Member']['status']); ?>&nbsp;</td>
		<td><?php echo h($member['Member']['date_added']); ?>&nbsp;</td>
		<td><?php echo h($member['Member']['last_modified']); ?>&nbsp;</td>
		<td class="actions">
